    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.subtitle}>{users.length} user{users.length !== 1 ? 's' : ''} found</Text>
            </View>
                    ...
                    <View style={styles.userCard}>
                        <View style={styles.userInfo}>
                            ...
                            <View style={styles.detailRow}>
                                ...
                                <Text style={styles.detailValue}>{(item.roles || []).join(', ') || 'None'}</Text>
                            </View>
                            <View style={styles.detailRow}>
                                <Text style={styles.detailLabel}>Departments:</Text>
                                <Text style={styles.detailValue}>{(item.departments || []).join(', ') || 'None'}</Text>
                            </View>
                        </View>
                        <TouchableOpacity
